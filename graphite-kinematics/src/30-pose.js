...
(function (GK) {
  ...
  const PRESETS = {
    ...
    'pinch': {
      label: 'Pinch',
      spec: {
        wrist: [0, 0, 0], arch: 0.36, thumb: [0.59, 0.42, 0.80, 0.34, 0.21],
        f: [[0.56, 0.51, 0.04, -0.37], [0.62, 0.70, 0.48, 0], [0.72, 0.82, 0.56, 0.05], [0.78, 0.86, 0.58, 0.10]]
      }
    },
    'ok': {
      label: 'OK',
      spec: {
        wrist: [-0.05, 0, 0], arch: 0.22, thumb: [0.57, 0.42, 0.76, 0.33, 0.20],
        f: [[0.55, 0.47, 0.02, -0.51], [-0.10, -0.15, -0.25, 0.30], [-0.10, -0.20, -0.30, 0.35], [-0.05, -0.20, -0.30, 0.55]]
      }
    },
    'point': {
      label: 'Point',
    ...
    'tripod': {
      label: 'Writing grip',
      spec: {
        wrist: [0.06, 0.14, 0], arch: 0.46, thumb: [0.61, 0.49, 0.65, 0.31, 0.20],
        f: [[0.44, 0.40, 0.20, -0.20], [0.59, 0.46, 0.06, 0.04], [0.72, 0.84, 0.56, 0.10], [0.80, 0.90, 0.60, 0.18]]
      }
    },
    'hook': {
      label: 'Hook',
