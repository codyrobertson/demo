...
(function (GK) {
  ...
  /* local-only:start — cut from dist/artifact.html by build.mjs. The host
     sandbox grants no page the right to hand the viewer a file, so this
     whole path is dead there; left in, its object-URL fallback is still
     an offer of a download the page cannot keep. */
  /**
